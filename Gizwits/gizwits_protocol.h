...
* @{
*/
#define PRODUCT_KEY "b34c6b6b471d41a1ae2cce7cc0c88a61"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "f17361e5d0ed45bea684898112e064d4"
...
* @{
*/
#define power_flag_BYTEOFFSET                    0
#define power_flag_BITOFFSET                     0
#define power_flag_LEN                           1
#define smoke_BYTEOFFSET                    8
#define smoke_BITOFFSET                     0
#define smoke_LEN                           1

#define smoke_threshold_RATIO                         1
#define smoke_threshold_ADDITION                      0
#define smoke_threshold_MIN                           0
#define smoke_threshold_MAX                           500
...
#define smoke_data_RATIO                         1
#define smoke_data_ADDITION                      0
#define smoke_data_MIN                           0
#define smoke_data_MAX                           1000
/**@} */
...
typedef struct {
  bool valuepower_flag;
  uint32_t valuesmoke_threshold;
  uint32_t valuehumidity;
  float valuetemperature;
  uint32_t valuesmoke_data;
  bool valuesmoke;
} dataPoint_t;
...
typedef struct {
  uint8_t flagpower_flag:1;
  uint8_t flagsmoke_threshold:1;
} attrFlags_t;
